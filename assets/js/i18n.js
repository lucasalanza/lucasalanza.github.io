...
(function () {
  ...
  const dict = {
    en: {
      ...
      "portfolio.featuresLabel": "Features",
      "portfolio.screenshotsLabel": "Admin panel screenshots",
      "portfolio.requestDemoAccess": "Request demo access",
      "portfolio.demoRequestMessage": "Hi! I saw the {project} template on your portfolio and would like to request temporary demo access to the admin panel.",
      "portfolio.screenshot.login": "Admin login",
      "portfolio.screenshot.dashboard": "Admin dashboard",
      "portfolio.screenshot.gallery": "Gallery management",
      "portfolio.screenshot.services": "Services management",
      "portfolio.screenshot.serviceForm": "Creating/editing a service",
      "portfolio.screenshot.testimonials": "Testimonials management",
      "portfolio.screenshot.tips": "Tips/blog management",
      ...
      "portfolio.revestidos.feature.catalog": "Product catalog with size/color variations and per-variation stock",
      "portfolio.revestidos.feature.categories": "Categories and subcategories",
      "portfolio.revestidos.feature.blog": "Care tips blog for each product type",
      "portfolio.revestidos.feature.dashboard": "Sample orders and clients dashboard (demo data, no real checkout yet)",
      "portfolio.revestidos.feature.admin": "Everything editable from a custom admin panel",
      "portfolio.revestidos.screenshot.categories": "Categories management",
      "portfolio.revestidos.screenshot.products": "Product catalog",
      "portfolio.revestidos.screenshot.productForm": "Creating/editing a product",
      "portfolio.revestidos.screenshot.clients": "Clients list",
      "portfolio.revestidos.screenshot.orders": "Sample orders dashboard",
      ...
      "portfolio.salao.feature.gallery": "Photo gallery of past work",
      "portfolio.salao.feature.services": "Service list",
      "portfolio.salao.feature.team": "Team profiles",
      "portfolio.salao.feature.testimonials": "Client testimonials",
      "portfolio.salao.feature.admin": "Everything editable from a custom admin panel — no coding required",
      "portfolio.salao.screenshot.team": "Team management",
      ...
      "portfolio.estetica.feature.gallery": "Photo gallery",
      "portfolio.estetica.feature.services": "Services with pricing, including discounted \"from/for\" packages",
      "portfolio.estetica.feature.products": "Recommended products with a \"where to buy\" link",
      "portfolio.estetica.feature.blog": "Maintenance tips blog",
      "portfolio.estetica.feature.pickup": "Vehicle pickup and drop-off info",
      "portfolio.estetica.feature.admin": "Everything editable from a custom admin panel",
      "portfolio.estetica.screenshot.products": "Recommended products management",
      ...
      "portfolio.personal.feature.gallery": "Photo gallery",
      "portfolio.personal.feature.services": "Service list",
      "portfolio.personal.feature.blog": "Training tips blog — each tip gets its own page",
      "portfolio.personal.feature.professionals": "Staff profiles, including credentials (e.g. CREF)",
      "portfolio.personal.feature.locations": "Service locations",
      "portfolio.personal.feature.testimonials": "Client testimonials",
      "portfolio.personal.feature.admin": "Everything editable from a custom admin panel",
      "portfolio.personal.screenshot.professionals": "Staff management",
      "portfolio.personal.screenshot.locations": "Service locations management",
      "portfolio.personal.screenshot.tipForm": "Creating/editing a training tip",
      ...
      "portfolio.oficina.feature.gallery": "Photo gallery",
      "portfolio.oficina.feature.services": "Services with free-text pricing or discounted combo packages",
      "portfolio.oficina.feature.products": "Recommended parts with a \"where to buy\" link",
      "portfolio.oficina.feature.blog": "Maintenance tips blog",
      "portfolio.oficina.feature.pickup": "Vehicle pickup/drop-off and partner tow-truck info",
      "portfolio.oficina.feature.testimonials": "Client testimonials",
      "portfolio.oficina.feature.admin": "Everything editable from a custom admin panel",
      "portfolio.oficina.screenshot.products": "Recommended parts management",
    ...
    pt: {
      ...
      "portfolio.featuresLabel": "Funcionalidades",
      "portfolio.screenshotsLabel": "Capturas do painel admin",
      "portfolio.requestDemoAccess": "Solicitar acesso de demonstração",
      "portfolio.demoRequestMessage": "Olá! Vi o template {project} no seu portfólio e gostaria de solicitar acesso temporário de demonstração ao painel admin.",
      "portfolio.screenshot.login": "Login do admin",
      "portfolio.screenshot.dashboard": "Dashboard do admin",
      "portfolio.screenshot.gallery": "Gerenciamento da galeria",
      "portfolio.screenshot.services": "Gerenciamento de serviços",
      "portfolio.screenshot.serviceForm": "Criando/editando um serviço",
      "portfolio.screenshot.testimonials": "Gerenciamento de depoimentos",
      "portfolio.screenshot.tips": "Gerenciamento das dicas/blog",
      ...
      "portfolio.revestidos.feature.catalog": "Catálogo de produtos com variação de tamanho/cor e estoque por variação",
      "portfolio.revestidos.feature.categories": "Categorias e subcategorias",
      "portfolio.revestidos.feature.blog": "Blog de dicas de cuidado com a peça",
      "portfolio.revestidos.feature.dashboard": "Painel com pedidos e clientes de exemplo (dado de demonstração, sem checkout real ainda)",
      "portfolio.revestidos.feature.admin": "Tudo editável por um painel admin próprio",
      "portfolio.revestidos.screenshot.categories": "Gerenciamento de categorias",
      "portfolio.revestidos.screenshot.products": "Catálogo de produtos",
      "portfolio.revestidos.screenshot.productForm": "Criando/editando um produto",
      "portfolio.revestidos.screenshot.clients": "Lista de clientes",
      "portfolio.revestidos.screenshot.orders": "Painel de pedidos de exemplo",
      ...
      "portfolio.salao.feature.gallery": "Galeria de fotos dos trabalhos",
      "portfolio.salao.feature.services": "Lista de serviços",
      "portfolio.salao.feature.team": "Perfil da equipe",
      "portfolio.salao.feature.testimonials": "Depoimentos de clientes",
      "portfolio.salao.feature.admin": "Tudo editável por um painel admin próprio, sem mexer em código",
      "portfolio.salao.screenshot.team": "Gerenciamento da equipe",
      ...
      "portfolio.estetica.feature.gallery": "Galeria de fotos",
      "portfolio.estetica.feature.services": "Serviços com preço, inclusive pacotes com desconto \"de/por\"",
      "portfolio.estetica.feature.products": "Produtos recomendados com link \"onde comprar\"",
      "portfolio.estetica.feature.blog": "Blog de dicas de manutenção",
      "portfolio.estetica.feature.pickup": "Informações de busca e entrega do veículo",
      "portfolio.estetica.feature.admin": "Tudo editável por um painel admin próprio",
      "portfolio.estetica.screenshot.products": "Gerenciamento de produtos recomendados",
      ...
      "portfolio.personal.feature.gallery": "Galeria de fotos",
      "portfolio.personal.feature.services": "Lista de serviços",
      "portfolio.personal.feature.blog": "Blog de dicas de treino — cada dica com página própria",
      "portfolio.personal.feature.professionals": "Perfil dos profissionais, incluindo credencial (ex. CREF)",
      "portfolio.personal.feature.locations": "Locais de atendimento",
      "portfolio.personal.feature.testimonials": "Depoimentos de clientes",
      "portfolio.personal.feature.admin": "Tudo editável por um painel admin próprio",
      "portfolio.personal.screenshot.professionals": "Gerenciamento dos profissionais",
      "portfolio.personal.screenshot.locations": "Gerenciamento dos locais de atendimento",
      "portfolio.personal.screenshot.tipForm": "Criando/editando uma dica de treino",
      ...
      "portfolio.oficina.feature.gallery": "Galeria de fotos",
      "portfolio.oficina.feature.services": "Serviços com preço livre ou pacote com desconto",
      "portfolio.oficina.feature.products": "Peças recomendadas com link \"onde comprar\"",
      "portfolio.oficina.feature.blog": "Blog de dicas de manutenção",
      "portfolio.oficina.feature.pickup": "Busca e entrega do veículo e guincho parceiro",
      "portfolio.oficina.feature.testimonials": "Depoimentos de clientes",
      "portfolio.oficina.feature.admin": "Tudo editável por um painel admin próprio",
      "portfolio.oficina.screenshot.products": "Gerenciamento de peças recomendadas",
      "portfolio.eununca.title": "Eu Nunca",
  ...
  function updateWhatsappLinks(lang) {
    const titleEl = document.querySelector("h1[data-i18n]");
    const project = titleEl ? titleEl.textContent : "";
    const template = dict[lang]["portfolio.demoRequestMessage"];
    document.querySelectorAll(".whatsapp-demo-link").forEach((el) => {
      const message = template.replace("{project}", project);
      el.setAttribute("href", `https://wa.me/5518981102937?text=${encodeURIComponent(message)}`);
    });
  }
