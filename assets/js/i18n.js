...
(function () {
  ...
  const dict = {
    en: {
      ...
      "portfolio.oficina.title": "Auto Repair Shop Template",
      "portfolio.oficina.desc": "Reusable site template for auto repair shops — services, recommended parts, maintenance tips, gallery, and pickup/tow-truck info, all editable from a custom admin panel. Built with .NET 9, Vue 3, and MySQL.",
      "portfolio.oficina.goal": "Give any auto repair shop a professional site — services, parts, and gallery — ready to launch and manage without touching code.",
    ...
    pt: {
      ...
      "portfolio.oficina.title": "Template para Oficina Mecânica",
      "portfolio.oficina.desc": "Template reutilizável para oficinas mecânicas — serviços, peças recomendadas, dicas de manutenção, galeria e informações de busca/guincho, tudo editável por um painel admin próprio. Construído com .NET 9, Vue 3 e MySQL.",
      "portfolio.oficina.goal": "Dar a qualquer oficina mecânica um site profissional — serviços, peças e galeria — pronto para lançar e gerenciar sem mexer em código.",
      "portfolio.eununca.title": "Eu Nunca",
