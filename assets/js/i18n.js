...
(function () {
  ...
  const dict = {
    en: {
      ...
      "portfolio.revestidos.desc": "Reusable business site template — product catalog with size/color variants, blog with care tips, and admin dashboard with fictitious sales data, all editable from a custom admin panel. Built with .NET 9, Vue 3, and MySQL.",
      "portfolio.salao.title": "Beauty Salon Template",
      "portfolio.salao.desc": "Reusable business site template — portfolio gallery, services, team, and testimonials, all editable from a custom admin panel. Built with .NET 9, Vue 3, and MySQL.",
      "portfolio.estetica.title": "Car Detailing Template",
      "portfolio.estetica.desc": "Reusable business site template — services with pricing, recommended products, maintenance tips, and gallery, all editable from a custom admin panel. Built with .NET 9, Vue 3, and MySQL.",
      "portfolio.personal.title": "Personal Trainer Template",
      "portfolio.personal.desc": "Reusable business site template — services, training tips blog, professionals, service locations, and testimonials, all editable from a custom admin panel. Built with .NET 9, Vue 3, and MySQL.",
    ...
    pt: {
      ...
      "portfolio.revestidos.title": "Revestidos de Graça",
      "portfolio.revestidos.desc": "Template reutilizável de site institucional — catálogo de produtos com variantes de tamanho/cor, blog com dicas de cuidado e dashboard admin com dados fictícios de vendas, tudo editável por um painel admin próprio. Construído com .NET 9, Vue 3 e MySQL.",
      "portfolio.salao.title": "Template para Salão de Beleza",
      "portfolio.salao.desc": "Template reutilizável de site institucional — galeria de trabalhos, serviços, equipe e depoimentos, tudo editável por um painel admin próprio. Construído com .NET 9, Vue 3 e MySQL.",
      "portfolio.estetica.title": "Template para Estética Automotiva",
      "portfolio.estetica.desc": "Template reutilizável de site institucional — serviços com preço, produtos recomendados, dicas de manutenção e galeria, tudo editável por um painel admin próprio. Construído com .NET 9, Vue 3 e MySQL.",
      "portfolio.personal.title": "Template para Personal Trainer",
      "portfolio.personal.desc": "Template reutilizável de site institucional — serviços, blog de dicas de treino, profissionais, locais de atendimento e depoimentos, tudo editável por um painel admin próprio. Construído com .NET 9, Vue 3 e MySQL.",
      "portfolio.eununca.title": "Eu Nunca",
