...
- Projetos de cliente privado (Lumus Care, Inara Studio Tee, Revestidos de Graça) ganham link **somente se o site estiver de fato publicado e acessível** — nunca inventar link de GitHub/demo pra projeto que não tem nada no ar. Os 3 templates genéricos (salão de beleza, estética automotiva, personal trainer) são vitrines de venda, não projetos de cliente — sempre com link, descritos como "template reutilizável".
